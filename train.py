...
def parse_args():
    ...
    parser.add_argument('--name', default='BASEPET-MRI/666', help='model name: (default: arch+timestamp)')
...
def main():
    ...
    training_data_loader1 = DataLoader(H5Dataset(r"/scratch/zenghui/MyDatasets/PET-MRI/train/PET_MRI_train_imgsize_64_stride_10.h5"),
